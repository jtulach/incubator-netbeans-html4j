...
public class React {
    ...
    public static Object createElement(String type, Object model, Object... children) {
        Object rawModel = Models.toRaw(model);
    ...
    private static native Object createElement0(String type, Object model, Object... children);
    
    public static void register(String name, ComponentFactory cf) {
    ...
    @JavaScriptBody(args = { "clazz", "id" }, body = "" +
        "let elem = document.getElementById(id);\n" +
        "if (!elem) throw 'Cannot find element ' + id;\n" +
        "ReactDOM.render(React.createElement(clazz), elem);\n" +
        "\n" 
    )
    private static native void render0(Object clazz, String id);
